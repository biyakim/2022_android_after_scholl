...
//        val root = LinearLayout(this)
//        //android:orientation="vertical"과 통일한 역할
//        root.orientation=LinearLayout.VERTICAL
...
//            LinearLayout.LayoutParams.MATCH_PARENT
//        )
//        //10dp 클 해당 단말기에서 사용될 pixel 단위값으로 변환
//        val DPToPX=TypedValue.applyDimension(
//            TypedValue.COMPLEX_UNIT_DIP,
//            20f,
//            resources.displayMetrics
//        ).toInt()
//        Log.d("my?_tag",DPToPX.toString())
//
//        val btn = Button(this)
...
//        //Q) 가로는 match_parent, 높이는 height으로 정하기
//        //layoutParams 에는 부모와 연관되어있는 android: 속성들을 정의하기 위해서 사용
//        //ex) width, height,margin
//        editText.layoutParams=LinearLayout.LayoutParams(
//            LinearLayout.LayoutParams.MATCH_PARENT,
//            height
//        )
//        //Q) 검색을 하던지 해서 배경 색상 바꿔보기(노란색으로?)
